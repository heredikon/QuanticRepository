...
import com.mycompany.cuanticrepository.ComplexQuantic;
 ...
 * @author fabia
 */
public class ComplexQuanticTests extends TestCase {
    Basic basic = new Basic();
    ComplexQuantic quantumSystem = new ComplexQuantic();
     ...
     */
    public ComplexQuanticTests(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(ComplexQuanticTests.class);
    }
